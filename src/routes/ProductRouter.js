...
router.get('/liked/me', AuthPermission('', true), ProductController.getAllProductLiked);

router.get('/viewed/me', AuthPermission('', true), ProductController.getAllProductViewed);
...
router.post('/unlike', AuthPermission('', true), ProductController.unlikeProduct);
